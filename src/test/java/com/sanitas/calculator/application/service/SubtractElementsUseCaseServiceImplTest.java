...
public class SubtractElementsUseCaseServiceImplTest {

    @InjectMocks
    private SubtractElementsUseCaseServiceImpl subtractElementsUseCaseService;

    @BeforeEach
    public void setUp() {

        this.subtractElementsUseCaseService = new SubtractElementsUseCaseServiceImpl();
    }

    @Test
    void executeWithPositiveNumbers(){

        OperationView result = subtractElementsUseCaseService.execute(
                SubtractOperationQuery.builder()
                        .firstNumber(1.0)
                        .secondNumber(1.0)
                        .build()
        );
